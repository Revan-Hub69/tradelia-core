...
// Journey Icons - Tradelia 2026
export const BoltIcon: React.FC<IconProps> = ({ className = "w-4 h-4", size }) => (
  <svg 
    className={className} 
    width={size} 
    height={size} 
...
export const GrowthIcon: React.FC<IconProps> = ({ className = "w-4 h-4", size }) => (
  <svg 
    className={className} 
    width={size} 
    height={size} 
...
export const TargetIcon: React.FC<IconProps> = ({ className = "w-4 h-4", size }) => (
  <svg 
    className={className} 
    width={size} 
    height={size} 
...
// Theme Icons - Consolidated from ThemeToggle.tsx
...
export const MonitorIcon: React.FC<IconProps> = ({ className = "w-4 h-4", size }) => (
  <svg 
    className={className} 
    width={size} 
    height={size} 
...
// Google Icon - Consolidated with system colors
...
// Missing icons for Emergency Dashboard
export const ChartBarIcon: React.FC<IconProps> = ({ className = "w-4 h-4", size }) => (
  <svg 
    className={className} 
    width={size} 
    height={size} 
...
export const ExpandIcon: React.FC<IconProps> = ({ className = "w-4 h-4", size }) => (
  <svg 
    className={className} 
    width={size} 
    height={size} 
...
export const MinimizeIcon: React.FC<IconProps> = ({ className = "w-4 h-4", size }) => (
  <svg 
    className={className} 
    width={size} 
    height={size} 
