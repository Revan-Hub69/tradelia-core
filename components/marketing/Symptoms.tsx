        ...
        <div className="space-y-4 mb-8">
          {symptoms.map((symptom, i) => (
            <div key={i} className="flex items-start gap-4 p-6 rounded-2xl bg-card border border-border">
              ...
              <p className="text-base leading-relaxed pt-0.5 text-foreground">{symptom}</p>
            </div>
          ))}
        </div>
        ...
        <UnifiedCard variant="elevated" className="bg-primary/5 border-primary/20">
          <CardContent>
            <div className="text-center text-base flex items-center justify-center gap-2">
              ...
              <span className="text-foreground"><strong>È normale.</strong> Il problema non è la tua intelligenza, ma come vengono spiegate le cose online.</span>
            </div>
          </CardContent>
        </UnifiedCard>
      </div>
