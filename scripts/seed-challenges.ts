...
const challenges = [
  ...
  // FTMO FREE TRIAL
  {
    ...
    account_size: 100000,
    scaling_potential: null,
    profit_split: JSON.stringify({ initial: 0, scaled: null, maximum: 0 }),
    rules: JSON.stringify({
      profitTarget: 10,
      maxDailyLoss: 5,
      maxDrawdown: 10,
    ...
    pros: JSON.stringify(['Completely FREE', 'No credit card required', '$100K virtual account', 'Real FTMO conditions', 'Test all platforms', '14 days duration']),
