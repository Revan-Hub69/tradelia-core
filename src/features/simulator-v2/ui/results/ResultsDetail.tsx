...
/**
 * Scheda dettaglio broker: slide-in da destra, sezioni ben strutturate.
 */
    ...
    >
      ...
      <div className="flex items-center justify-between border-b border-border/60 bg-card/80 px-4 py-3 backdrop-blur-sm">
        <button
          ...
          className="flex items-center gap-1.5 rounded-lg px-2 py-1 text-sm font-medium text-muted-foreground transition-colors hover:bg-muted hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
        >
      ...
      <div className="flex-1 space-y-5 overflow-y-auto p-4 sm:p-5">
          ...
          <div className="relative mt-5 grid grid-cols-3 gap-2 border-t border-border/40 pt-4">
            <MetricBox label="Costo/mese" primary>
              <AnimatedCounter
                ...
                className={cn(
                  'block text-xl font-bold leading-none tabular-nums tracking-tight',
            ...
            <MetricBox label="Costo/trade">
              <AnimatedCounter
                ...
                formatAction={v => formatEUR(v)}
                className="block text-xl font-bold leading-none tabular-nums tracking-tight text-foreground"
              />
            </MetricBox>
        ...
        {qual && (
          <section className="rounded-xl border border-amber-500/20 bg-amber-500/5 p-3.5">
            <h2 className="mb-2.5 flex items-center gap-1.5 text-[11px] font-semibold uppercase tracking-wider text-amber-600 dark:text-amber-500">
          ...
          <section>
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              {esmaLossRatePct !== undefined && (
                <SpecItem label="Loss rate ESMA" value={`${esmaLossRatePct}%`} />
              )}
            </div>
          </section>
        )}
        ...
        <p className="text-[10px] leading-relaxed text-muted-foreground/80">
          <ShieldCheck className="mr-1 inline size-3 align-text-bottom" />
          Costi calcolati su snapshot aggregato. Non include funding overnight, slippage e fee di deposito/prelievo. Il trading CFD comporta rischio elevato di perdita del capitale.
        </p>
      </div>
    </motion.div>
  );
