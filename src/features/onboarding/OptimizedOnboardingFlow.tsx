        ...
        <Card className="border-primary/20 bg-primary/5 p-6">
          ...
          <div className="space-y-3 text-sm">
            <div className="flex items-center gap-3">
              ...
              <span>Contenuti per il tuo livello</span>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <span>Focalizzato su quello che ti interessa</span>
            </div>

            <div className="flex items-center gap-3">
              <div className="size-8 rounded-lg bg-blue-500/10 p-1.5">
            ...
            <div className="flex items-center gap-3">
              <div className="size-8 rounded-lg bg-green-500/10 p-1.5">
                <svg className="size-full text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                </svg>
              </div>
              <span>Ti aiutiamo a evitare le fregature</span>
            </div>
          </div>
        </Card>
      </FadeIn>
