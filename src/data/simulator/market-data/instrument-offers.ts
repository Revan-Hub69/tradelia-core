...
export const INSTRUMENT_OFFERS: InstrumentOffer[] = [
  ...
  // ── TICKMILL PRO - RAW ECN (EUR/USD) ────────────────────────────
  {
    ...
    underlyingOverrides: {
      ...
      usdhkd:   { spreadAvgBps: 65, spreadMinBps: 0, spreadMaxBps: null, overnightLongPipsPerDay: +0.7,  overnightShortPipsPerDay: -95.72, marginRequirementPct: 5.00, slippageAvgBps: null },
    },
