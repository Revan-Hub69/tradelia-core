...
export function PWAInstallBanner() {
  ...
  return (
    <div className="fixed inset-x-4 bottom-4 z-40 mx-auto max-w-sm rounded-lg border bg-white p-4 shadow-lg dark:bg-gray-800 md:left-auto md:right-4 md:max-w-xs">
