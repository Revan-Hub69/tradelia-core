...
export const AdaptiveMicroCopyExample: React.FC = () => {
  ...
  return (
    <div className="adaptive-micro-copy-example">
      ...
      {/* Scenario Selector */}
      <div className="scenario-selector mb-8 p-6 bg-gray-50 rounded-xl">
      ...
      <div className="current-context mb-8 p-6 bg-blue-50 rounded-xl">
        ...
        <div className="interactive-demo mb-8">
          ...
          <div className="demo-grid grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="demo-section">
              <h3 className="text-lg font-medium text-gray-700 mb-4">Adaptive Buttons</h3>
              <div className="space-y-4">
                <div className="button-group">
                  <h4 className="text-sm font-medium text-gray-600 mb-2">Azioni Principali</h4>
                ...
                <div className="button-group">
                  <h4 className="text-sm font-medium text-gray-600 mb-2">Azioni Sensibili</h4>
                  <div className="flex flex-wrap gap-3">
            ...
            {/* Adaptive Status */}
            <div className="demo-section">
              <h3 className="text-lg font-medium text-gray-700 mb-4">Adaptive Status</h3>
              <div className="space-y-4">
                <AdaptiveStatus
                  type="info"
      ...
      <div className="technical-implementation mb-8 p-6 bg-gray-50 rounded-xl">
        <h2 className="text-xl font-semibold text-gray-800 mb-4">
          Implementazione Tecnica
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <h3 className="text-lg font-medium text-gray-900 mb-3">Context Provider</h3>
  ...
  <AdaptiveButton actionType="financial">
    Paga
          ...
          <div>
            <h3 className="text-lg font-medium text-gray-900 mb-3">Adaptive Hook</h3>
            <div className="bg-gray-900 rounded-lg p-4 text-sm">
              <pre className="text-green-400">
