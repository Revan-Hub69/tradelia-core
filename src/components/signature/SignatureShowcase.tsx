  ...
  return (
    <div className="space-y-8 p-8">
      ...
      <HeroBanner className="text-center">
        <h1 className="text-3xl font-bold mb-4">Tradelia Signature Design</h1>
      ...
      <ContentCard>
        <h2 className="text-xl font-semibold mb-4">Signature Shapes</h2>
      ...
      <div className="space-y-4">
        <SupportingElement>
          <h3 className="font-medium mb-2">Visual Hierarchy System</h3>
      ...
      <TradelliaGlass variant="modal" className="p-6">
        <h3 className="font-semibold mb-2">Raw Tradelia Glass</h3>
        <p className="text-sm opacity-80">
