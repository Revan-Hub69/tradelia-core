      ...
      fc.assert(fc.property(
        ...
        (namespace) => {
          ...
          const requiredNavKeys = [
            'nav_home', 'nav_learn', 'nav_tools', 'nav_community', 'nav_profile'
          ];
      ...
      fc.assert(fc.property(
        ...
        (namespace) => {
          ...
          const requiredLearnKeys = [
            'title', 'description', 'main_path_title', 'main_path_description',
            'module1_title', 'module1_description',
            'module2_title', 'module2_description',
            'module3_title', 'module3_description',
            'module4_title', 'module4_description',
