/**
 * PREMIUM SVG ICONS - Challenge Library 2026
 *
 * Custom-designed icons following Tradelia design system:
 * - Liquid glass aesthetic
 * - 32px border radius consistency
 * - Soft cream palette
 * - NO EMOJI - Pure SVG craftsmanship
 *
 * Categories:
 * - Feature Icons (profit, drawdown, payout, etc.)
 * - Badge Icons (verified, featured, new, etc.)
 * - Platform Icons (MT4, MT5, cTrader, etc.)
 */
...
// Delete/Trash Icon
export const DeleteIcon = ({ size = 16, ...props }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
// Lightbulb Icon for Guide Section
export const LightbulbIcon = ({ size = 20, ...props }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
