      ...
      >
        ...
        <div className="relative mb-6">
          ...
          {animationPhase === 'celebrate' && (
            <>
              <Sparkles className="absolute -right-2 -top-2 size-6 animate-bounce text-yellow-400" />
              <Sparkles className="absolute -bottom-2 -left-2 size-6 animate-bounce text-yellow-400" style={{ animationDelay: '0.5s' }} />
              <Star className="absolute left-0 top-0 size-4 animate-ping text-orange-400" />
        ...
        <div className="pointer-events-none absolute inset-0">
          {[...Array(8)].map((_, i) => (
            ...
            >
              {i % 2 === 0
                ? (
                    <Star className="animate-spin-slow size-6 text-yellow-400" />
                  )
                : (
...
export const XPGainAnimation: React.FC<XPGainAnimationProps> = ({
  ...
  return (
    ...
    >
      <div className="rounded-lg border border-primary/20 bg-primary/10 px-4 py-2 shadow-lg backdrop-blur-sm">
        <div className="flex items-center gap-2">
          <Star className="size-4 animate-spin text-primary" />
