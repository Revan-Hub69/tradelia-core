...
const SECTION_IDS = [
  'controller', 'data', 'legal', 'cookies', 'third-parties',
  'retention', 'rights', 'transfers', 'changes',
] as const;
    ...
    <>
      ...
      <main id="main-content" className="min-h-screen bg-gradient-to-b from-background via-background to-muted/20">
        <SectionContainer size="content" className="py-16 sm:py-18 lg:py-20">
          ...
          {/* Callout */}
          <div className="mb-10 flex gap-3 rounded-xl border border-primary/20 bg-primary/5 px-5 py-4">
