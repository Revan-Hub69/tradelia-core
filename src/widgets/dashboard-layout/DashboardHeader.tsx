...
export function DashboardHeader({ onMenuClick, sidebarOpen }: DashboardHeaderProps) {
  ...
  return (
    <header className="h-16 bg-background/95 border-b border-border/50 sticky top-0 z-50 supports-[backdrop-filter]:bg-background/80 supports-[backdrop-filter]:backdrop-blur-sm">
