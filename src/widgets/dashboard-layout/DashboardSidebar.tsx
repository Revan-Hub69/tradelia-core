 ...
 * 
 * Sidebar overlay semplice e funzionale:
 * - Slide-in da sinistra
 * - Click fuori chiude (backdrop separato)
 * - ESC chiude (gestito dal parent)
 * - Nessun scroll interno, tutto scorre naturalmente
 */
...
export function DashboardSidebar({ isOpen, onClose }: DashboardSidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        ref={sidebarRef}
        className="fixed top-0 left-0 z-50 h-full w-80 bg-background border-r border-border shadow-2xl flex flex-col"
        role="dialog"
        aria-modal="true"
      ...
      >
        ...
        {/* Bottom Section */}
        <div className="p-6 border-t border-border/30 space-y-4 flex-shrink-0">
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-muted-foreground hover:text-red-500 hover:bg-red-500/10 transition-all duration-200"
          >
