      ...
      <SectionContainer size="wide">
        ...
        <div className="mt-10 grid gap-4 md:grid-cols-2 xl:grid-cols-3 2xl:gap-6">
          {steps.map(step => (
            <div
              key={step.num}
              className="relative overflow-hidden rounded-[28px] border border-border/60 bg-card p-6 shadow-[0_18px_50px_-36px_rgba(15,23,42,0.38)] sm:p-7 xl:p-8"
            >
              ...
              <h3 className="mt-5 max-w-64 text-xl font-semibold leading-snug tracking-tight">
                {t(step.titleKey)}
              </h3>
