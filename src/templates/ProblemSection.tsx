      ...
      <SectionContainer size="wide">
        <FadeIn>
          <div className="grid gap-8 xl:grid-cols-[0.88fr_1.12fr] xl:gap-14 2xl:gap-16">
            ...
            <div className="rounded-[32px] border border-border/60 bg-background p-6 shadow-[0_24px_60px_-42px_rgba(15,23,42,0.38)] sm:p-7 xl:p-8">
              <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-muted-foreground/55">
                {t('matrix_title')}
              </p>

              <div className="mt-4 overflow-x-auto rounded-[24px] border border-border/50">
                <div className="grid min-w-[40rem] grid-cols-[1.05fr_0.7fr_1.25fr] gap-px bg-border/50 md:min-w-0">
